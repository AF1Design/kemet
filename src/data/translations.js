export const translations = {
  ar: {
    ...
    navAllProducts: "المنتجات الأكثر مبيعاً",
    navOrders: "الطلبات",
    navMyOrders: "طلباتي ومتابعة الشحنة",
    navTrackOrder: "تتبع الشحنة",
    navStory: "قصة KEMET",
    ...
    catShortsDesc: "حقائب رياضية، شنكار ومستلزمات رياضية",
    storyPreviewTitle: "📜 قصة KEMET",
    storyPreviewText: "بدأت قصة KEMET لما اشترى مؤسسها قميصاً رياضياً واكتشف إن المنتج ما كانش قد التوقعات. فقررنا نبني KEMET بخامات تفوق التوقعات وقيمة تستحق كل جنيه...",
    readStoryBtn: "اقرأ القصة بالكامل 📜",

    // Story Page & Section
    storyTitle: "قصة KEMET",
    storySubtitle: "من شغف كرة القدم والجودة الحقيقية.. كيف بدأت رحلتنا لبناء KEMET",
    ...
    trackOrderTitle: "تتبع الشحنة",
    trackOrderSubtitle: "أدخل كود التتبع المرفق في رسالة الشحن لمعرفة مكان شحنتك وحالتها فورياً",
    ...
    trackWhatsappBtn: "استفسار مباشر عبر الواتساب 📱",
    ...
    loginTitle: "حساب KEMET",
    loginSubtitle: "قم بتسجيل الدخول لمتابعة طلباتك وإدارتها فورياً",
    ...
    // Checkout Page
    checkoutTitle: "إتمام طلب الشراء",
    ...
    orderSuccessDesc: "شكراً لطلبك من KEMET! سيتم إرسال كود التتبع على الواتساب فور شحن الطلب.",
    backHomeBtn: "العودة للصفحة الرئيسية",

    // Why KEMET?
    whyTitle: "لماذا KEMET؟",
    ...
    // Footer
    footerAbout: "مصممون ومتخصصون في تقديم أحدث الملابس والأطقم الرياضية الفاخرة التي تجمع بين الجودة والأداء الرفيع.",
  ...
  en: {
    // Header & Navigation
    promoText: "🔥 Official 2027 Kits Offer (Player Edition) 280 EGP instead of 400 EGP | Nationwide Shipping!",
    navHome: "Home",
    navCategories: "Categories",
    navKits: "2027 Official Kits",
    navTraining: "2027 Gym & Activewear",
    navShorts: "Sports Accessories & Gear",
    navAllProducts: "Best Sellers",
    navOrders: "Orders",
    navMyOrders: "My Orders & Status",
    navTrackOrder: "Track Shipment",
    ...
    // Hero Section
    heroBadge: "👑 Official 2027 Player Edition Kits",
    heroTitle: "Comfort & Design on Us.. Performance on You",
    heroSubtitle: "Engineered activewear built to high quality standards for peak performance on field and gym.",
    heroCtaPrimary: "Shop New Collection",
    heroCtaSecondary: "Explore Categories",
    heroStat1: "100% Player Edition Fabrics",
    heroStat2: "Nationwide Express Shipping",
    ...
    categoriesSubtitle: "Select any category to view its dedicated products",
    catKitsDesc: "Browse Official 2027 Player Edition Kits",
    catTrainingDesc: "Gym compression wear, cut tees & athletic shorts",
    catShortsDesc: "Sports bags, shin guards & accessories",
    storyPreviewTitle: "📜 The KEMET Story",
    storyPreviewText: "The KEMET story began when its founder bought a sports jersey and discovered the quality fell short. So we built KEMET with fabrics that exceed expectations...",
    readStoryBtn: "Read Full Story 📜",

    // Story Page
    storyTitle: "The KEMET Story",
    storySubtitle: "Born from a passion for football and true quality.. How our journey began to build KEMET",
    ...
    // Order Tracking Feature
    trackOrderTitle: "Track Shipment",
    trackOrderSubtitle: "Enter your tracking code to view your live shipment status",
    trackInputPlaceholder: "Enter tracking number (e.g. EG123456789EG or KM-9842)",
    trackBtn: "Track Shipment Now 🔍",
    ...
    // Login & Register & Profile Settings
    loginTitle: "KEMET Account",
    loginSubtitle: "Sign in with your account to track and manage your orders",
    loginTab: "Sign In",
    ...
    phonePlaceholder: "010xxxxxxxx",
    smsMarketingLabel: "📱 Agree to receive exclusive KEMET offers via SMS",
    loginBtn: "Sign In 🔑",
    registerBtn: "Create Account 🚀",
    welcomeBackUser: "Welcome back,",
    accountActivePhone: "Account active with phone:",
    viewOrdersBtn: "View My Orders & Status 🛍️",
    browseProductsBtn: "Browse Products & Kits ⚽",
    guestCheckoutNotice: "Order without an account?",
    ...
    spec3: "🛡️ Full warranty against defects.",
    ...
    returnRule2Desc: "If the product arrives with manufacturing defects or differs from photos, keep the product and receive a full refund.",
    ...
    codNotice: "💵 Payment Method: Cash on Delivery with full defect warranty.",
    submitOrder: "Confirm & Place Order 🛍️",
    ...
    feature2Desc: "Fast and reliable shipping to all governorates within 2-4 business days.",
    ...
    // Footer
    footerAbout: "Crafting athletic wear that combines performance, quality, and Egyptian heritage.",
    ...
    whatsappChannelBtn: "Join KEMET WhatsApp Channel",
