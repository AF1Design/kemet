  ...
  return (
    <div className="mobile-drawer-overlay" onClick={onClose}>
      <div className="mobile-drawer-content" onClick={e => e.stopPropagation()}>
        ...
        {/* Mobile Drawer Header - Prominent Language & Theme Toggles at the Top */}
        <div className="mobile-drawer-header">
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
            ...
            <button 
              ...
              style={{ padding: '0.35rem 0.6rem', border: '1px solid var(--border-gold-bright)', borderRadius: 'var(--radius-md)' }} 
              title="Language / تغيير اللغة"
            >
              <span style={{ fontWeight: 800, fontSize: '0.8rem', color: 'var(--gold-primary)' }}>
                {lang === 'ar' ? 'EN' : 'عربي'}
              </span>
            </button>
            ...
            <button 
              ...
              onClick={toggleTheme} 
              className="action-icon-btn" 
              style={{ padding: '0.4rem', border: '1px solid var(--border-color)', borderRadius: 'var(--radius-md)' }} 
              title={lang === 'ar' ? 'تغيير المود' : 'Toggle Theme'}
            >
              {theme === 'dark' ? (
