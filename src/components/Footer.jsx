  ...
  return (
    <footer className="footer">
      <div className="container">
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '2.5rem', marginBottom: '3.5rem' }}>
          ...
          <div>
            ...
            >
              ...
              <span>قناة KEMET Family على الواتساب</span>
            </a>
          </div>
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '0.85rem', flexWrap: 'wrap' }}>
              ...
              {/* Instagram Page Link */}
              <a 
                href="https://www.instagram.com/kemet.ya?igsh=MXBuNWEydnc3NXIyYw%3D%3D&utm_source=qr" 
                target="_blank" 
                rel="noreferrer"
                title="حساب KEMET على إنستجرام"
                style={{ 
                  width: '44px', 
                  height: '44px', 
                  borderRadius: '50%', 
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer"
                title="قناة KEMET Family على الواتساب"
                style={{ 
                  width: '44px', 
                  height: '44px', 
                  borderRadius: '50%', 
        ...
        <div style={{ textAlign: 'center', paddingTop: '2rem', borderTop: '1px solid var(--border-color)', fontSize: '0.85rem', color: 'var(--text-muted)' }}>
          <p>{t('copyright')}</p>
        </div>
      </div>
    </footer>
