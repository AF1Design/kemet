...
const GA_ID = process.env.NEXT_PUBLIC_GA_MEASUREMENT_ID || 'G-CSPVC65Z0V';
const GTM_ID = process.env.NEXT_PUBLIC_GTM_ID;
const META_PIXEL_ID = process.env.NEXT_PUBLIC_META_PIXEL_ID || '1768720384147304';
          ...
          <Script id="google-analytics" strategy="afterInteractive">
            {`
              ...
              gtag('config', '${GA_ID}', {
                ...
                send_page_view: false // Managed dynamically by NavigationTracker
              });
            `}
          </Script>
        </>
